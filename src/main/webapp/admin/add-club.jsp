...
<section class="py-5">
  <div class="container">
    <div class="form-shell">
      ...
      <form id="addClubForm" action="${pageContext.request.contextPath}/admin/add-club" method="post" enctype="multipart/form-data" class="row g-3" novalidate autocomplete="off">
        <div class="col-12">
          ...
          <input class="form-control" id="clubName" name="name" placeholder="e.g. AI Innovation Club" required autocomplete="off">
        ...
        <div class="col-md-6">
          ...
          <input class="form-control" id="facultyCoordinator" name="facultyCoordinator" placeholder="Professor / Mentor" autocomplete="off">
        </div>
        <div class="col-md-6">
          ...
          <input class="form-control" id="studentCoordinator" name="studentCoordinator" placeholder="Lead student name" autocomplete="off">
        </div>
        <div class="col-12">
          ...
          <textarea class="form-control" id="description" name="description" rows="5" placeholder="Describe mission, flagship events, achievements" maxlength="1000" autocomplete="off"></textarea>
        ...
        <div class="col-12">
          ...
          <textarea class="form-control" id="engagement" name="engagement" rows="4" placeholder="e.g. Connect with the club leadership for volunteering, workshops, hackathons, and campus outreach opportunities. Join our weekly meetings every Friday at 4 PM." maxlength="500" autocomplete="off"></textarea>
          <div class="d-flex justify-content-between align-items-center mt-1">
        ...
        <div class="col-12">
          ...
          <div class="form-text mt-2">If skipped, a placeholder image will be used.</div>
          <div id="imageError" class="text-danger small mt-1 d-none"></div>
        </div>
        <div class="col-12">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              <button type="button" class="btn btn-sm btn-outline-secondary" id="clearForm"><i class="bi bi-arrow-clockwise"></i> Clear Form</button>
